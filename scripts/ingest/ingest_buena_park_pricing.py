"""
Ingests Buena Park venue pricing (chunks_buena_park_pricing.py). Mirrors
ingest_anaheim_pricing.py's structure.

Usage:
    source .venv/bin/activate
    python ingest_buena_park_pricing.py
    psql "$DATABASE_URL" -f ingest_buena_park_pricing.sql
"""

import os
import sys

from chunks_buena_park_pricing import CITY, DOCUMENTS, VENUES
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__), "ingest_buena_park_pricing.sql")
