"""
Ingests La Habra venue pricing (chunks_la_habra_pricing.py). Mirrors
ingest_brea_pricing.py's single-venue structure.

Usage:
    source .venv/bin/activate
    python ingest_la_habra_pricing.py
    psql "$DATABASE_URL" -f ingest_la_habra_pricing.sql
"""

import os
import sys

from chunks_la_habra_pricing import CITY, DOCUMENTS, VENUES
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__), "ingest_la_habra_pricing.sql")
