"""
Phase 4 API ingestion: Orange wedding-venue and gym listings from Google
Places API (New). Mirrors the established address-verification filter.

Usage:
    source .venv/bin/activate
    python ingest_google_places_orange.py
    psql "$DATABASE_URL" -f ingest_google_places_orange.sql
"""
...
SEARCH_QUERIES = [
    "wedding venue Orange CA",
    "gym Orange CA",
    "banquet hall event venue Orange CA",
]
...
""")
    ...
    out_path = os.path.join(os.path.dirname(__file__), "ingest_google_places_orange.sql")
