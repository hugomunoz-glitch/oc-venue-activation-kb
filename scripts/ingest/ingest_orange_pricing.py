"""
Ingests Orange venue pricing (chunks_orange_pricing.py). Mirrors
ingest_anaheim_pricing.py's structure.

Usage:
    source .venv/bin/activate
    python ingest_orange_pricing.py
    psql "$DATABASE_URL" -f ingest_orange_pricing.sql
"""

import os
import sys

from chunks_orange_pricing import CITY, DOCUMENTS, VENUES
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__), "ingest_orange_pricing.sql")
