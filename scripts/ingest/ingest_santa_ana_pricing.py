"""
Ingests Santa Ana venue pricing (chunks_santa_ana_pricing.py). Mirrors
ingest_anaheim_pricing.py's structure.

Usage:
    source .venv/bin/activate
    python ingest_santa_ana_pricing.py
    psql "$DATABASE_URL" -f ingest_santa_ana_pricing.sql
"""

import os
import sys

from chunks_santa_ana_pricing import CITY, DOCUMENTS, VENUES
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__), "ingest_santa_ana_pricing.sql")
